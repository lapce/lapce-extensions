...
pub mod user {
    ...
    pub mod plugins {
        ...
        use super::_prisma::*;
        use super::{OrderByParam, SetParam, UniqueWhereParam, WhereParam, WithParam};
        pub fn some(value: Vec<plugin::WhereParam>) -> WhereParam {
            WhereParam::PluginsSome(value)
        }
        pub fn every(value: Vec<plugin::WhereParam>) -> WhereParam {
            WhereParam::PluginsEvery(value)
        }
        pub fn none(value: Vec<plugin::WhereParam>) -> WhereParam {
            WhereParam::PluginsNone(value)
        }
        pub struct Fetch(pub plugin::ManyArgs);
        impl Fetch {
            pub fn with(mut self, params: impl Into<plugin::WithParam>) -> Self {
                self.0 = self.0.with(params.into());
                self
            }
            pub fn order_by(mut self, param: plugin::OrderByParam) -> Self {
            ...
            pub fn cursor(mut self, value: plugin::UniqueWhereParam) -> Self {
        ...
        impl From<Fetch> for WithParam {
            fn from(fetch: Fetch) -> Self {
                WithParam::Plugins(fetch.0)
            }
        }
        pub fn fetch(params: Vec<plugin::WhereParam>) -> Fetch {
            Fetch(plugin::ManyArgs::new(params))
        }
        pub fn connect<T: From<Connect>>(params: Vec<plugin::UniqueWhereParam>) -> T {
            Connect(params).into()
        }
        pub fn disconnect(params: Vec<plugin::UniqueWhereParam>) -> SetParam {
            SetParam::DisconnectPlugins(params)
        }
        pub fn set(params: Vec<plugin::UniqueWhereParam>) -> SetParam {
            SetParam::SetPlugins(params)
        }
        pub struct Connect(pub Vec<plugin::UniqueWhereParam>);
        impl From<Connect> for SetParam {
            fn from(value: Connect) -> Self {
                Self::ConnectPlugins(value.0)
            }
        }
        pub enum Include {
            Select(plugin::ManyArgs, Vec<plugin::SelectParam>),
            Include(plugin::ManyArgs, Vec<plugin::IncludeParam>),
            Fetch(plugin::ManyArgs),
        }
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::Plugins(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                let mut selection = ::prisma_client_rust::Selection::builder("plugins");
                match self {
                    ...
                    Self::Include(args, selections) => {
                        selection.set_arguments(args.to_graphql().0);
                        let mut nested_selections = plugin::_outputs();
                        nested_selections.extend(selections.into_iter().map(|s| s.to_selection()));
                        selection.nested_selections(nested_selections);
                    }
                    Self::Fetch(args) => {
                        selection.set_arguments(args.to_graphql().0);
                        selection.nested_selections(plugin::_outputs());
                    }
                }
                selection.build()
            }
            pub fn select(
                args: plugin::ManyArgs,
                nested_selections: Vec<plugin::SelectParam>,
            ) -> Self {
                Self::Select(args, nested_selections)
            }
            pub fn include(
                args: plugin::ManyArgs,
                nested_selections: Vec<plugin::IncludeParam>,
            ) -> Self {
        ...
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::Plugins(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::Plugins(data) => data.to_selection(),
            }
        }
    }
    #[macro_export]
    ...
    pub struct Data {
        ...
        pub plugins: Option<Vec<super::plugin::Data>>,
    }
    impl Data {
        pub fn plugins(
            &self,
        ) -> Result<&Vec<super::plugin::Data>, ::prisma_client_rust::RelationNotFetchedError>
        {
            self.plugins
                .as_ref()
        ...
        fn into(self) -> ::prisma_client_rust::Selection {
            match self {
                Self::Plugins(args) => {
                    ...
                    nested_selections.extend(super::plugin::_outputs());
                    let mut builder = ::prisma_client_rust::Selection::builder("plugins");
                    builder
    ...
    pub enum SetParam {
        ...
        SetUsername(String),
        SetAvatarUrl(String),
        ConnectPlugins(Vec<super::plugin::UniqueWhereParam>),
        DisconnectPlugins(Vec<super::plugin::UniqueWhereParam>),
        SetPlugins(Vec<super::plugin::UniqueWhereParam>),
    }
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for SetParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                SetParam::ConnectPlugins(where_params) => (
                    "plugins".to_string(),
                    ::prisma_client_rust::PrismaValue::Object(vec![(
                        "connect".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                            where_params
                                .into_iter()
                                .map(Into::<super::plugin::WhereParam>::into)
                ...
                SetParam::DisconnectPlugins(where_params) => (
                    "plugins".to_string(),
                    ::prisma_client_rust::PrismaValue::Object(vec![(
                ...
                SetParam::SetPlugins(where_params) => (
                    "plugins".to_string(),
                    ::prisma_client_rust::PrismaValue::Object(vec![(
                        "set".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
    ...
    pub enum WhereParam {
        ...
        AvatarUrlNot(String),
        PluginsSome(Vec<super::plugin::WhereParam>),
        PluginsEvery(Vec<super::plugin::WhereParam>),
        PluginsNone(Vec<super::plugin::WhereParam>),
    }
    impl Into<::prisma_client_rust::SerializedWhere> for WhereParam {
        fn into(self) -> ::prisma_client_rust::SerializedWhere {
            match self {
                ...
                Self::PluginsSome(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "plugins",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "some".to_string(),
                ...
                Self::PluginsEvery(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "plugins",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "every".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::PluginsNone(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "plugins",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "none".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
...
pub mod plugin {
    ...
    pub mod publisher {
        ...
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                let mut selection = ::prisma_client_rust::Selection::builder("publisher");
                match self {
    ...
    pub mod publisher_id {
        ...
        pub fn equals(value: i64) -> WhereParam {
            WhereParam::PublisherIdEquals(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::PublisherId(direction)
        }
        pub fn in_vec(value: Vec<i64>) -> WhereParam {
            WhereParam::PublisherIdInVec(value)
        }
        pub fn not_in_vec(value: Vec<i64>) -> WhereParam {
            WhereParam::PublisherIdNotInVec(value)
        }
        pub fn lt(value: i64) -> WhereParam {
            WhereParam::PublisherIdLt(value)
        }
        pub fn lte(value: i64) -> WhereParam {
            WhereParam::PublisherIdLte(value)
        }
        pub fn gt(value: i64) -> WhereParam {
            WhereParam::PublisherIdGt(value)
        }
        pub fn gte(value: i64) -> WhereParam {
            WhereParam::PublisherIdGte(value)
        }
        pub fn not(value: i64) -> WhereParam {
            WhereParam::PublisherIdNot(value)
        }
        pub fn increment(value: i64) -> SetParam {
            SetParam::IncrementPublisherId(value)
        }
        pub fn decrement(value: i64) -> SetParam {
            SetParam::DecrementPublisherId(value)
        }
        pub fn multiply(value: i64) -> SetParam {
            SetParam::MultiplyPublisherId(value)
        }
        pub fn divide(value: i64) -> SetParam {
            SetParam::DividePublisherId(value)
        }
        pub struct Set(pub i64);
        impl From<Set> for SetParam {
            fn from(value: Set) -> Self {
                Self::SetPublisherId(value.0)
            }
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
        ...
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::Selection::builder("publisherId").build()
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
    ...
    pub mod versions {
        ...
        use super::_prisma::*;
        use super::{OrderByParam, SetParam, UniqueWhereParam, WhereParam, WithParam};
        pub fn some(value: Vec<version::WhereParam>) -> WhereParam {
            WhereParam::VersionsSome(value)
        }
        pub fn every(value: Vec<version::WhereParam>) -> WhereParam {
            WhereParam::VersionsEvery(value)
        }
        pub fn none(value: Vec<version::WhereParam>) -> WhereParam {
            WhereParam::VersionsNone(value)
        }
        pub struct Fetch(pub version::ManyArgs);
        impl Fetch {
            pub fn with(mut self, params: impl Into<version::WithParam>) -> Self {
                self.0 = self.0.with(params.into());
                self
            }
            pub fn order_by(mut self, param: version::OrderByParam) -> Self {
                self.0 = self.0.order_by(param);
                self
            }
            pub fn skip(mut self, value: i64) -> Self {
            ...
            pub fn cursor(mut self, value: version::UniqueWhereParam) -> Self {
                self.0 = self.0.cursor(value.into());
                self
            }
        }
        impl From<Fetch> for WithParam {
            fn from(fetch: Fetch) -> Self {
                WithParam::Versions(fetch.0)
            }
        }
        pub fn fetch(params: Vec<version::WhereParam>) -> Fetch {
            Fetch(version::ManyArgs::new(params))
        }
        pub fn connect<T: From<Connect>>(params: Vec<version::UniqueWhereParam>) -> T {
            Connect(params).into()
        }
        pub fn disconnect(params: Vec<version::UniqueWhereParam>) -> SetParam {
            SetParam::DisconnectVersions(params)
        }
        pub fn set(params: Vec<version::UniqueWhereParam>) -> SetParam {
            SetParam::SetVersions(params)
        }
        pub struct Connect(pub Vec<version::UniqueWhereParam>);
        impl From<Connect> for SetParam {
            fn from(value: Connect) -> Self {
                Self::ConnectVersions(value.0)
            }
        }
        pub enum Include {
            Select(version::ManyArgs, Vec<version::SelectParam>),
            Include(version::ManyArgs, Vec<version::IncludeParam>),
            Fetch(version::ManyArgs),
        }
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
        ...
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                let mut selection = ::prisma_client_rust::Selection::builder("versions");
                match self {
                    Self::Select(args, selections) => {
                        selection.set_arguments(args.to_graphql().0);
                        selection.nested_selections(
                    ...
                    Self::Include(args, selections) => {
                        selection.set_arguments(args.to_graphql().0);
                        let mut nested_selections = version::_outputs();
                        nested_selections.extend(selections.into_iter().map(|s| s.to_selection()));
                        selection.nested_selections(nested_selections);
                    }
                    Self::Fetch(args) => {
                        selection.set_arguments(args.to_graphql().0);
                        selection.nested_selections(version::_outputs());
                    }
                }
                selection.build()
            }
            pub fn select(
                args: version::ManyArgs,
                nested_selections: Vec<version::SelectParam>,
            ) -> Self {
                Self::Select(args, nested_selections)
            }
            pub fn include(
                args: version::ManyArgs,
                nested_selections: Vec<version::IncludeParam>,
            ) -> Self {
                Self::Include(args, nested_selections)
            }
        }
    ...
    pub fn create(
        ...
        publisher_id: i64,
        _params: Vec<SetParam>,
    ) -> (String, String, String, String, i64, Vec<SetParam>) {
        (
            name,
            description,
            display_name,
    ...
    pub struct Data {
        ...
        pub publisher: Option<Box<super::user::Data>>,
        #[serde(rename = "publisherId")]
        pub publisher_id: i64,
        #[serde(rename = "versions")]
        pub versions: Option<Vec<super::version::Data>>,
    }
    impl Data {
        pub fn publisher(
            &self,
        ...
        pub fn versions(
            &self,
        ) -> Result<&Vec<super::version::Data>, ::prisma_client_rust::RelationNotFetchedError>
        {
            self.versions
                .as_ref()
                .ok_or(::prisma_client_rust::RelationNotFetchedError::new(
    ...
    #[derive(Clone)]
    pub enum WithParam {
        Publisher(super::user::UniqueArgs),
        Versions(super::version::ManyArgs),
    }
    impl Into<::prisma_client_rust::Selection> for WithParam {
        fn into(self) -> ::prisma_client_rust::Selection {
            match self {
                Self::Publisher(args) => {
                    ...
                    let mut builder = ::prisma_client_rust::Selection::builder("publisher");
                    builder.nested_selections(selections);
                    builder.build()
                }
                Self::Versions(args) => {
                    let (arguments, mut nested_selections) = args.to_graphql();
                    nested_selections.extend(super::version::_outputs());
                    let mut builder = ::prisma_client_rust::Selection::builder("versions");
                    builder
                        .nested_selections(nested_selections)
                        .set_arguments(arguments);
                    builder.build()
    ...
    pub enum SetParam {
        ...
        SetAuthor(String),
        ConnectPublisher(super::user::UniqueWhereParam),
        SetPublisherId(i64),
        IncrementPublisherId(i64),
        DecrementPublisherId(i64),
        MultiplyPublisherId(i64),
        DividePublisherId(i64),
        ConnectVersions(Vec<super::version::UniqueWhereParam>),
        DisconnectVersions(Vec<super::version::UniqueWhereParam>),
        SetVersions(Vec<super::version::UniqueWhereParam>),
    }
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for SetParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                SetParam::ConnectVersions(where_params) => (
                    ...
                    ::prisma_client_rust::PrismaValue::Object(vec![(
                        ...
                        ::prisma_client_rust::PrismaValue::List(
                            where_params
                                .into_iter()
                                .map(Into::<super::version::WhereParam>::into)
                                .map(Into::<::prisma_client_rust::SerializedWhere>::into)
                                .map(::prisma_client_rust::SerializedWhere::transform_equals)
                                .map(|v| ::prisma_client_rust::PrismaValue::Object(vec![v]))
                                .collect(),
    ...
    pub enum WhereParam {
        ...
        AuthorMode(QueryMode),
        AuthorNot(String),
        PublisherIs(Vec<super::user::WhereParam>),
        PublisherIsNot(Vec<super::user::WhereParam>),
        PublisherIdEquals(i64),
        PublisherIdInVec(Vec<i64>),
        PublisherIdNotInVec(Vec<i64>),
        PublisherIdLt(i64),
        PublisherIdLte(i64),
        PublisherIdGt(i64),
        PublisherIdGte(i64),
        PublisherIdNot(i64),
        VersionsSome(Vec<super::version::WhereParam>),
        VersionsEvery(Vec<super::version::WhereParam>),
        VersionsNone(Vec<super::version::WhereParam>),
    }
    impl Into<::prisma_client_rust::SerializedWhere> for WhereParam {
        fn into(self) -> ::prisma_client_rust::SerializedWhere {
            match self {
                ...
                Self::AuthorEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "in".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::AuthorNotInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "notIn".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::AuthorLt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorLte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorGt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorGte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorContains(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "contains".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorStartsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "startsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorEndsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "endsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::AuthorMode(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "mode".to_string(),
                        ::prisma_client_rust::PrismaValue::Enum(value.to_string()),
                ...
                Self::AuthorNot(value) => ::prisma_client_rust::SerializedWhere::new(
                    "author",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "not".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PublisherIs(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "publisher",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "is".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::PublisherIsNot(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "publisher",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "isNot".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::PublisherIdEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::PublisherIdInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "in".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::PublisherIdNotInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "notIn".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::PublisherIdLt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lt".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::PublisherIdLte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lte".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::PublisherIdGt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gt".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::PublisherIdGte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gte".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::PublisherIdNot(value) => ::prisma_client_rust::SerializedWhere::new(
                    "publisherId",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "not".to_string(),
                        ::prisma_client_rust::PrismaValue::BigInt(value),
                ...
                Self::VersionsSome(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "versions",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "some".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::VersionsEvery(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "versions",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "every".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::VersionsNone(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "versions",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "none".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
    ...
    impl<'a> Actions<'a> {
        pub fn find_unique(self, _where: UniqueWhereParam) -> FindUnique<'a> {
            FindUnique::new(
                self.client._new_query_context(),
                ::prisma_client_rust::QueryInfo::new("Plugin", _outputs()),
                _where.into(),
            )
        }
        pub fn find_first(self, _where: Vec<WhereParam>) -> FindFirst<'a> {
        ...
        pub fn create(
            ...
            display_name: String,
            author: String,
            publisher: super::user::UniqueWhereParam,
            mut _params: Vec<SetParam>,
        ) -> Create<'a> {
            _params.push(name::set(name));
            ...
            _params.push(publisher::connect(publisher));
            Create::new(
                self.client._new_query_context(),
                ::prisma_client_rust::QueryInfo::new("Plugin", _outputs()),
                _params,
        ...
        pub fn create_many(
            self,
            data: Vec<(String, String, String, String, i64, Vec<SetParam>)>,
        ) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(
                    |(name, description, display_name, author, publisher_id, mut _params)| {
                        _params.push(name::set(name));
                        _params.push(description::set(description));
                        _params.push(display_name::set(display_name));
                        _params.push(author::set(author));
                        _params.push(publisher_id::set(publisher_id));
                        _params
                    },
                )
                .collect();
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (name, description, display_name, author, publisher, mut _params): (
                String,
                String,
                String,
                String,
...
pub mod version {
    ...
    pub mod plugin {
        ...
        use super::_prisma::*;
        use super::{OrderByParam, SetParam, UniqueWhereParam, WhereParam, WithParam};
        pub fn is(value: Vec<plugin::WhereParam>) -> WhereParam {
            WhereParam::PluginIs(value)
        }
        pub fn is_not(value: Vec<plugin::WhereParam>) -> WhereParam {
            WhereParam::PluginIsNot(value)
        }
        pub struct Fetch(pub plugin::UniqueArgs);
        impl Fetch {
            pub fn with(mut self, params: impl Into<plugin::WithParam>) -> Self {
                self.0 = self.0.with(params.into());
                self
        ...
        impl From<Fetch> for WithParam {
            fn from(fetch: Fetch) -> Self {
                WithParam::Plugin(fetch.0)
            }
        }
        pub fn fetch() -> Fetch {
            Fetch(plugin::UniqueArgs::new())
        }
        pub fn connect<T: From<Connect>>(value: plugin::UniqueWhereParam) -> T {
            Connect(value).into()
        }
        pub struct Connect(plugin::UniqueWhereParam);
        impl From<Connect> for SetParam {
            fn from(value: Connect) -> Self {
                Self::ConnectPlugin(value.0)
            }
        }
        pub enum Include {
            Select(Vec<plugin::SelectParam>),
            Include(Vec<plugin::IncludeParam>),
            Fetch,
        }
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
        ...
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                let mut selection = ::prisma_client_rust::Selection::builder("plugin");
                match self {
                    Self::Select(selections) => {
                        selection.nested_selections(
                            selections.into_iter().map(|s| s.to_selection()).collect(),
            ...
            pub fn select(nested_selections: Vec<plugin::SelectParam>) -> Self {
                Self::Select(nested_selections)
            }
            pub fn include(nested_selections: Vec<plugin::IncludeParam>) -> Self {
                Self::Include(nested_selections)
            }
        }
        pub enum Select {
    ...
    pub mod plugin_name {
        ...
        pub fn equals(value: String) -> WhereParam {
            WhereParam::PluginNameEquals(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::PluginName(direction)
        }
        pub fn in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::PluginNameInVec(value)
        }
        pub fn not_in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::PluginNameNotInVec(value)
        }
        pub fn lt(value: String) -> WhereParam {
            WhereParam::PluginNameLt(value)
        }
        pub fn lte(value: String) -> WhereParam {
            WhereParam::PluginNameLte(value)
        }
        pub fn gt(value: String) -> WhereParam {
            WhereParam::PluginNameGt(value)
        }
        pub fn gte(value: String) -> WhereParam {
            WhereParam::PluginNameGte(value)
        }
        pub fn contains(value: String) -> WhereParam {
            WhereParam::PluginNameContains(value)
        }
        pub fn starts_with(value: String) -> WhereParam {
            WhereParam::PluginNameStartsWith(value)
        }
        pub fn ends_with(value: String) -> WhereParam {
            WhereParam::PluginNameEndsWith(value)
        }
        pub fn mode(value: QueryMode) -> WhereParam {
            WhereParam::PluginNameMode(value)
        }
        pub fn not(value: String) -> WhereParam {
            WhereParam::PluginNameNot(value)
        }
        pub struct Set(pub String);
        impl From<Set> for SetParam {
            fn from(value: Set) -> Self {
                Self::SetPluginName(value.0)
            }
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::PluginName(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::Selection::builder("pluginName").build()
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::PluginName(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub mod yanked {
        ...
        pub fn equals(value: bool) -> WhereParam {
            WhereParam::YankedEquals(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::Yanked(direction)
        }
        pub struct Set(pub bool);
        impl From<Set> for SetParam {
            fn from(value: Set) -> Self {
                Self::SetYanked(value.0)
            }
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::Yanked(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::Selection::builder("yanked").build()
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::Yanked(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub mod digest {
        ...
        pub fn equals(value: String) -> WhereParam {
            WhereParam::DigestEquals(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::Digest(direction)
        }
        pub fn in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::DigestInVec(value)
        }
        pub fn not_in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::DigestNotInVec(value)
        }
        pub fn lt(value: String) -> WhereParam {
            WhereParam::DigestLt(value)
        }
        pub fn lte(value: String) -> WhereParam {
            WhereParam::DigestLte(value)
        }
        pub fn gt(value: String) -> WhereParam {
            WhereParam::DigestGt(value)
        }
        pub fn gte(value: String) -> WhereParam {
            WhereParam::DigestGte(value)
        }
        pub fn contains(value: String) -> WhereParam {
            WhereParam::DigestContains(value)
        }
        pub fn starts_with(value: String) -> WhereParam {
            WhereParam::DigestStartsWith(value)
        }
        pub fn ends_with(value: String) -> WhereParam {
            WhereParam::DigestEndsWith(value)
        }
        pub fn mode(value: QueryMode) -> WhereParam {
            WhereParam::DigestMode(value)
        }
        pub fn not(value: String) -> WhereParam {
            WhereParam::DigestNot(value)
        }
        pub struct Set(pub String);
        impl From<Set> for SetParam {
            fn from(value: Set) -> Self {
                Self::SetDigest(value.0)
            }
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::Digest(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::Selection::builder("digest").build()
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::Digest(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub fn version_plugin_name<T: From<UniqueWhereParam>>(
        version: String,
        plugin_name: String,
    ) -> T {
        UniqueWhereParam::VersionPluginNameEquals(version, plugin_name).into()
    }
    pub fn _outputs() -> Vec<::prisma_client_rust::Selection> {
        ["version", "pluginName", "yanked", "digest"]
            .into_iter()
            .map(|o| {
                let builder = ::prisma_client_rust::Selection::builder(o);
                builder.build()
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::PluginName(data) => data.to_selection(),
                Self::Yanked(data) => data.to_selection(),
                Self::Digest(data) => data.to_selection(),
            }
        }
    }
    #[macro_export]
    macro_rules ! _include_version { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { $ crate :: prisma :: version :: include ! (@ definitions ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Include (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: include :: IncludeType for Include { type Data = Data ; type ModelData = $ crate :: prisma :: version :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } use super :: * ; pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Include { let mut selections = $ crate :: prisma :: version :: _outputs () ; selections . extend ($ crate :: prisma :: version :: include ! (@ selections_to_include_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ())) ; Include (selections) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { $ crate :: prisma :: version :: include ! (@ definitions ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Include (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: include :: IncludeType for Include { type Data = Data ; type ModelData = $ crate :: prisma :: version :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Include ({ let mut selections = $ crate :: prisma :: version :: _outputs () ; selections . extend ($ crate :: prisma :: version :: include ! (@ selections_to_include_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ())) ; selections }) } } ; (@ definitions ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { plugin } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug)] pub struct Data { pub version : String , pub plugin_name : String , pub yanked : bool , pub digest : String , $ (pub $ field : $ crate :: prisma :: version :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (version) , stringify ! (plugin_name) , stringify ! (yanked) , stringify ! (digest)] . len ()) ? ; $ (state . serialize_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; $ field) , & self . $ field) ? ;) * state . serialize_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; version) , & self . version) ? ; state . serialize_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; plugin_name) , & self . plugin_name) ? ; state . serialize_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; yanked) , & self . yanked) ? ; state . serialize_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; digest) , & self . digest) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , version , plugin_name , yanked , digest } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (concat ! ($ ($ crate :: prisma :: version :: include ! (@ field_serde_name ; $ field) , ", ") , + , $ crate :: prisma :: version :: include ! (@ field_serde_name ; version) , ", " , $ crate :: prisma :: version :: include ! (@ field_serde_name ; plugin_name) , ", " , $ crate :: prisma :: version :: include ! (@ field_serde_name ; yanked) , ", " , $ crate :: prisma :: version :: include ! (@ field_serde_name ; digest) , ", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ ($ crate :: prisma :: version :: include ! (@ field_serde_name ; $ field) => Ok (Field :: $ field)) , * , $ crate :: prisma :: version :: include ! (@ field_serde_name ; version) => Ok (Field :: version) , $ crate :: prisma :: version :: include ! (@ field_serde_name ; plugin_name) => Ok (Field :: plugin_name) , $ crate :: prisma :: version :: include ! (@ field_serde_name ; yanked) => Ok (Field :: yanked) , $ crate :: prisma :: version :: include ! (@ field_serde_name ; digest) => Ok (Field :: digest) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut version = None ; let mut plugin_name = None ; let mut yanked = None ; let mut digest = None ; while let Some (key) = map . next_key () ? { match key { Field :: version => { if version . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; version))) ; } version = Some (map . next_value () ?) ; } Field :: plugin_name => { if plugin_name . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; plugin_name))) ; } plugin_name = Some (map . next_value () ?) ; } Field :: yanked => { if yanked . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; yanked))) ; } yanked = Some (map . next_value () ?) ; } Field :: digest => { if digest . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; digest))) ; } digest = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; $ field))) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; $ field))) ? ;) * let version = version . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; version))) ? ; let plugin_name = plugin_name . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; plugin_name))) ? ; let yanked = yanked . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; yanked))) ? ; let digest = digest . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: version :: include ! (@ field_serde_name ; digest))) ? ; Ok (Data { version , plugin_name , yanked , digest , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["version" , "plugin" , "pluginName" , "yanked" , "digest"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { $ crate :: prisma :: version :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; plugin : $ selection_mode : ident { $ ($ selections : tt) + }) => { plugin :: Data } ; (@ field_type ; plugin) => { crate :: prisma :: plugin :: Data } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Version" , available relations are "plugin")) } ; (@ field_module ; plugin : $ selection_mode : ident { $ ($ selections : tt) + }) => { $ crate :: prisma :: plugin :: include ! (@ definitions ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; plugin $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < $ crate :: prisma :: version :: IncludeParam > :: into ($ crate :: prisma :: version :: plugin :: Include :: $ selection_mode ($ crate :: prisma :: plugin :: include ! (@ selections_to_include_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; plugin $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < $ crate :: prisma :: version :: IncludeParam > :: into ($ crate :: prisma :: version :: plugin :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_include_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ ($ crate :: prisma :: version :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; version) => { "version" } ; (@ field_serde_name ; plugin) => { "plugin" } ; (@ field_serde_name ; plugin_name) => { "pluginName" } ; (@ field_serde_name ; yanked) => { "yanked" } ; (@ field_serde_name ; digest) => { "digest" } ; }
    pub use _include_version as include;
    pub enum IncludeParam {
        Version(version::Include),
        Plugin(plugin::Include),
        PluginName(plugin_name::Include),
        Yanked(yanked::Include),
        Digest(digest::Include),
    }
    impl IncludeParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
    ...
    pub struct Data {
        ...
        pub version: String,
        #[serde(rename = "plugin")]
        pub plugin: Option<Box<super::plugin::Data>>,
    ...
    impl Data {
        pub fn plugin(
            &self,
        ) -> Result<&super::plugin::Data, ::prisma_client_rust::RelationNotFetchedError> {
            self.plugin
                .as_ref()
                .ok_or(::prisma_client_rust::RelationNotFetchedError::new(
                    stringify!(plugin),
    ...
    #[derive(Clone)]
    pub enum WithParam {
        Plugin(super::plugin::UniqueArgs),
    }
    impl Into<::prisma_client_rust::Selection> for WithParam {
        fn into(self) -> ::prisma_client_rust::Selection {
            match self {
                Self::Plugin(args) => {
                    let mut selections = super::plugin::_outputs();
                    selections.extend(
                        args.with_params
                            .into_iter()
                            .map(Into::<::prisma_client_rust::Selection>::into),
                    );
                    let mut builder = ::prisma_client_rust::Selection::builder("plugin");
                    builder.nested_selections(selections);
                    builder.build()
                }
            }
    ...
    pub enum SetParam {
        SetVersion(String),
        ConnectPlugin(super::plugin::UniqueWhereParam),
    ...
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for SetParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                SetParam::ConnectPlugin(where_param) => (
                    "plugin".to_string(),
                    ::prisma_client_rust::PrismaValue::Object(vec![(
                        "connect".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                SetParam::SetPluginName(value) => (
                    "pluginName".to_string(),
                    ::prisma_client_rust::PrismaValue::String(value),
                ),
                SetParam::SetYanked(value) => (
                    "yanked".to_string(),
                    ::prisma_client_rust::PrismaValue::Boolean(value),
                ),
                SetParam::SetDigest(value) => (
                    "digest".to_string(),
                    ::prisma_client_rust::PrismaValue::String(value),
                ),
            }
    ...
    pub enum OrderByParam {
        ...
        PluginName(::prisma_client_rust::Direction),
        Yanked(::prisma_client_rust::Direction),
        Digest(::prisma_client_rust::Direction),
    }
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                Self::PluginName(direction) => (
                    "pluginName".to_string(),
                    ::prisma_client_rust::PrismaValue::String(direction.to_string()),
                ),
                Self::Yanked(direction) => (
                    "yanked".to_string(),
                    ::prisma_client_rust::PrismaValue::String(direction.to_string()),
                ),
                Self::Digest(direction) => (
                    "digest".to_string(),
                    ::prisma_client_rust::PrismaValue::String(direction.to_string()),
                ),
            }
    ...
    pub enum WhereParam {
        ...
        Or(Vec<WhereParam>),
        And(Vec<WhereParam>),
        VersionPluginNameEquals(String, String),
        ...
        VersionMode(QueryMode),
        VersionNot(String),
        PluginIs(Vec<super::plugin::WhereParam>),
        PluginIsNot(Vec<super::plugin::WhereParam>),
        PluginNameEquals(String),
        PluginNameInVec(Vec<String>),
        PluginNameNotInVec(Vec<String>),
        PluginNameLt(String),
        PluginNameLte(String),
        PluginNameGt(String),
        PluginNameGte(String),
        PluginNameContains(String),
        PluginNameStartsWith(String),
        PluginNameEndsWith(String),
        PluginNameMode(QueryMode),
        PluginNameNot(String),
        YankedEquals(bool),
        DigestEquals(String),
        DigestInVec(Vec<String>),
        DigestNotInVec(Vec<String>),
        DigestLt(String),
        DigestLte(String),
        DigestGt(String),
        DigestGte(String),
        DigestContains(String),
        DigestStartsWith(String),
        DigestEndsWith(String),
        DigestMode(QueryMode),
        DigestNot(String),
    }
    impl Into<::prisma_client_rust::SerializedWhere> for WhereParam {
        fn into(self) -> ::prisma_client_rust::SerializedWhere {
            match self {
                ...
                Self::VersionPluginNameEquals(version, plugin_name) => {
                    ::prisma_client_rust::SerializedWhere::new(
                        ...
                        ::prisma_client_rust::SerializedWhereValue::Object(vec![
                            ...
                            (
                                "pluginName".to_string(),
                                ::prisma_client_rust::PrismaValue::String(plugin_name),
                            ),
                        ]),
                    )
                }
                Self::VersionEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "in".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::VersionNotInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "notIn".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::VersionLt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionLte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionGt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionGte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionContains(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "contains".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionStartsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "startsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionEndsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "endsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::VersionMode(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "mode".to_string(),
                        ::prisma_client_rust::PrismaValue::Enum(value.to_string()),
                ...
                Self::VersionNot(value) => ::prisma_client_rust::SerializedWhere::new(
                    "version",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "not".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginIs(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "plugin",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "is".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::PluginIsNot(where_params) => ::prisma_client_rust::SerializedWhere::new(
                    "plugin",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "isNot".to_string(),
                        ::prisma_client_rust::PrismaValue::Object(
                ...
                Self::PluginNameEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "in".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::PluginNameNotInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "notIn".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::PluginNameLt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameLte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameGt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameGte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameContains(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "contains".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameStartsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "startsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameEndsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "endsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::PluginNameMode(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "mode".to_string(),
                        ::prisma_client_rust::PrismaValue::Enum(value.to_string()),
                ...
                Self::PluginNameNot(value) => ::prisma_client_rust::SerializedWhere::new(
                    "pluginName",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "not".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::YankedEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "yanked",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::Boolean(value),
                ...
                Self::DigestEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "in".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::DigestNotInVec(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "notIn".to_string(),
                        ::prisma_client_rust::PrismaValue::List(
                ...
                Self::DigestLt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestLte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "lte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestGt(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gt".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestGte(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "gte".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestContains(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "contains".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestStartsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "startsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestEndsWith(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "endsWith".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
                ...
                Self::DigestMode(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "mode".to_string(),
                        ::prisma_client_rust::PrismaValue::Enum(value.to_string()),
                ...
                Self::DigestNot(value) => ::prisma_client_rust::SerializedWhere::new(
                    "digest",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "not".to_string(),
                        ::prisma_client_rust::PrismaValue::String(value),
    ...
    impl From<UniqueWhereParam> for WhereParam {
        fn from(value: UniqueWhereParam) -> Self {
            match value {
                UniqueWhereParam::VersionPluginNameEquals(version, plugin_name) => {
                    Self::VersionPluginNameEquals(version, plugin_name)
                }
            }
        }
    ...
    impl<'a> Actions<'a> {
        pub fn find_unique(self, _where: UniqueWhereParam) -> FindUnique<'a> {
            FindUnique::new(
                self.client._new_query_context(),
                ::prisma_client_rust::QueryInfo::new("Version", _outputs()),
                _where.into(),
            )
        }
        pub fn find_first(self, _where: Vec<WhereParam>) -> FindFirst<'a> {
        ...
        pub fn create(
            self,
            version: String,
            plugin: super::plugin::UniqueWhereParam,
            yanked: bool,
            digest: String,
            mut _params: Vec<SetParam>,
        ) -> Create<'a> {
            _params.push(version::set(version));
            _params.push(plugin::connect(plugin));
            _params.push(yanked::set(yanked));
            _params.push(digest::set(digest));
            Create::new(
                self.client._new_query_context(),
                ::prisma_client_rust::QueryInfo::new("Version", _outputs()),
                _params,
        ...
        pub fn create_many(
            self,
            data: Vec<(String, String, bool, String, Vec<SetParam>)>,
        ) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(|(version, plugin_name, yanked, digest, mut _params)| {
                    _params.push(version::set(version));
                    _params.push(plugin_name::set(plugin_name));
                    _params.push(yanked::set(yanked));
                    _params.push(digest::set(digest));
                    _params
                })
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (version, plugin, yanked, digest, mut _params): (
                String,
                super::plugin::UniqueWhereParam,
                bool,
                String,
                Vec<SetParam>,
            ),
...
pub mod _prisma {
    ...
    impl PrismaClient {
        ...
        pub fn plugin(&self) -> super::plugin::Actions {
            super::plugin::Actions { client: &self }
        }
        pub fn version(&self) -> super::version::Actions {
            super::version::Actions { client: &self }
        }
    }
    #[derive(Debug, Clone, Copy, :: serde :: Serialize, :: serde :: Deserialize)]
    pub enum PluginScalarFieldEnum {
        #[serde(rename = "name")]
        Name,
        #[serde(rename = "description")]
        Description,
    ...
    impl ToString for PluginScalarFieldEnum {
    ...
    #[derive(Debug, Clone, Copy, :: serde :: Serialize, :: serde :: Deserialize)]
    pub enum VersionScalarFieldEnum {
        #[serde(rename = "version")]
        Version,
        #[serde(rename = "pluginName")]
        PluginName,
    ...
    impl ToString for VersionScalarFieldEnum {
        fn to_string(&self) -> String {
            match self {
                Self::Version => "version".to_string(),
                Self::PluginName => "pluginName".to_string(),
                Self::Yanked => "yanked".to_string(),
