...
pub mod version {
    ...
    pub mod preview {
        ...
        pub fn equals(value: bool) -> WhereParam {
            WhereParam::PreviewEquals(value).into()
        }
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::Preview(direction)
        }
        pub struct Set(pub bool);
        impl From<Set> for SetParam {
            fn from(value: Set) -> Self {
                Self::SetPreview(value.0)
            }
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::Preview(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::Selection::builder("preview").build()
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::Preview(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub fn _outputs() -> Vec<::prisma_client_rust::Selection> {
        ["version", "pluginName", "yanked", "digest", "preview"]
            .into_iter()
            .map(|o| {
                let builder = ::prisma_client_rust::Selection::builder(o);
                builder.build()
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::Preview(data) => data.to_selection(),
            }
        }
    }
    #[macro_export]
    ...
    pub enum OrderByParam {
        ...
        Preview(::prisma_client_rust::Direction),
    }
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
    ...
    impl Into<::prisma_client_rust::SerializedWhere> for WhereParam {
        fn into(self) -> ::prisma_client_rust::SerializedWhere {
            match self {
                ...
                Self::PreviewEquals(value) => ::prisma_client_rust::SerializedWhere::new(
                    "preview",
                    ::prisma_client_rust::SerializedWhereValue::Object(vec![(
                        "equals".to_string(),
                        ::prisma_client_rust::PrismaValue::Boolean(value),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create(
            ...
            _params.push(preview::set(preview));
            Create::new(
                self.client._new_query_context(),
                ::prisma_client_rust::QueryInfo::new("Version", _outputs()),
                _params,
        ...
        pub fn create_many(
            self,
            data: Vec<(String, String, bool, String, bool, Vec<SetParam>)>,
        ) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(
                    |(version, plugin_name, yanked, digest, preview, mut _params)| {
                        _params.push(version::set(version));
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (version, plugin, yanked, digest, preview, mut _params): (
                String,
